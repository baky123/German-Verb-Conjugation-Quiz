...
class PlayFrame(tk.Frame):
    ...
    def create_gui(self):
        # the questions
        tk.Label(self, name="p1question", text="THIS IS A QUESTION", justify=tk.LEFT, wraplength=150).grid(row=0, column=1, columnspan=2)
        tk.Label(self, name="p2question", text="THIS IS A QUESTION", justify=tk.RIGHT, wraplength=150).grid(row=0, column=4, columnspan=2)
        # player 1's score
        ...
        tk.Button(self, name="abtn1p1", text="ANSWER", command=partial(self.answer, 1, 1)).grid(row=1, column=0, sticky=tk.E+tk.W)
        tk.Button(self, name="abtn2p1", text="ANSWER", command=partial(self.answer, 2, 1)).grid(row=1, column=1, sticky=tk.E+tk.W)
        tk.Button(self, name="abtn3p1", text="ANSWER", command=partial(self.answer, 3, 1)).grid(row=2, column=0, sticky=tk.E+tk.W)
        tk.Button(self, name="abtn4p1", text="ANSWER", command=partial(self.answer, 4, 1)).grid(row=2, column=1, sticky=tk.E+tk.W)
        # player 2's answer buttons
        tk.Button(self, name="abtn1p2", text="ANSWER", command=partial(self.answer, 1, 2)).grid(row=1, column=0+5, sticky=tk.E+tk.W)
        tk.Button(self, name="abtn2p2", text="ANSWER", command=partial(self.answer, 2, 2)).grid(row=1, column=1+5, sticky=tk.E+tk.W)
        tk.Button(self, name="abtn3p2", text="ANSWER", command=partial(self.answer, 3, 2)).grid(row=2, column=0+5, sticky=tk.E+tk.W)
        tk.Button(self, name="abtn4p2", text="ANSWER", command=partial(self.answer, 4, 2)).grid(row=2, column=1+5, sticky=tk.E+tk.W)
        # separator
        ...
        tk.Button(self, name="nextq", text="NEXT QUESTION").grid(row=4, columnspan=7, sticky=tk.E+tk.W)
...
class GameOverFrame(tk.Frame):
    ...
    def create_gui(self):
        ...
        tk.Button(self, text="RESTART", command=restart).grid(row=3, columnspan=2)
